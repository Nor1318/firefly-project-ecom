                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-900">$50.00</p>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-500 mb-1">Quantity</p>
                            <p class="text-sm text-gray-900">2</p>
                        </div>
                    </div>

                    <div class="flex gap-4 mt-6">
                        <a href="{{route('order_items.edit', ['order'=>1,'order_item'=>1])}}" class="px-6 py-2 bg-yellow-800 text-white rounded-lg">
                            Edit
                        </a>
                        <a href="" class="px-6 py-2 bg-red-800 text-white rounded-lg">
                            Delete
                        </a>
                    </div>
                </div>
