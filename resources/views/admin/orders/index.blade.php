        ...
        <main class="flex-auto p-6">
            ...
            <div class="bg-white rounded-lg shadow  ">
                <div class="p-4 border-b flex justify-between m-2">
                    ...
                    <button class="px-4 py-2 bg-blue-800 text-white rounded"><a href="{{route('orders.create')}}">Add Order</a></button>
                </div>
                <div>
                    <table class="w-full">
                        ...
                        <tbody class="bg-white ">
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <span class="px-2 py-1 font-bold text-xs">Completed</span>
                                </td>
