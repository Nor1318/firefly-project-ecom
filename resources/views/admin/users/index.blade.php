                    ...
                    <table class="w-full">
                        ...
                        <tbody class="bg-white">
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900">Bobby</td>
                                <td class="px-6 py-4 text-sm text-gray-900">bobby@gmail.com</td>
                                <td class="px-6 py-4 text-xs text-gray-900 font-bold">admin</td>

                                <td class="px-6 py-4 text-sm">
                                    <button class="px-2 py-1 border bg-green-800 border-green-700 text-white rounded-3xl"><a href="{{route('users.show',1)}}">View</a></button>
                                    <button class="px-2 py-1 border bg-yellow-800 border-yellow-700 text-white rounded-3xl"><a href="{{route('users.edit',1)}}">Edit</a></button>
