    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white">
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="{{route('productss.index')}}" class="block px-4 py-2 rounded click focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500">Product</a>
                ...
                <div class="p-6">
                    <form action="" method="POST" class="space-y-4">
                        ...
                        <div class="flex gap-2 pt-4 ">
                            <button type="submit" class="px-4 py-2 bg-blue-800 text-white rounded">Create Category</button>
