    ...
    <div class="p-6 border-b border-gray-200">
        ...
        <form action="{{route('payments.index')}}" method="GET" class="flex flex-col md:flex-row gap-4">
            ...
            <div class="w-full md:w-40">
                <select name="method" class="block w-full pl-3 pr-10 py-2 text-base border border-gray-300 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm rounded-lg">
            ...
            <a href="{{route('payments.index')}}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 transition-colors flex items-center justify-center whitespace-nowrap">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
