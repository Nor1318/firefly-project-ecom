    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white shadow-sm border-r border-gray-200">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{route('coupons.index')}}" class="flex items-center px-4 py-3 text-sm font-medium {{request()->routeIs('coupons.*') ? 'text-purple-600 bg-purple-50' : 'text-gray-700 hover:bg-gray-50'}} rounded-lg transition-colors group">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
